...
class LlmClient:
    ...
    def draft_response(self, request):      
        ...
        end_time1 = time.time()
        isflag = True
        print("request process time: (from the time when request come and rag pipeline including request body modified )", middle_time - start_time, start_time, middle_time)
